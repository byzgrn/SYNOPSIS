...
const [audioList, setAudioList] = useState([]);
    ...
    const renderAudio = ({item}: { item: AudioItem }) => <AudioCard audio={item} />;

    return (
        <View style={styles.container}>
            <View style={styles.buttonContainer}>
                <FontAwesome.Button name='plus' backgroundColor={colors.darkestbrown} onPress={navigateToAddAudioScreen}>Add Audio</FontAwesome.Button>
            </View>
            <FlatList
